...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/dict_toAddPage.action"
		method=post>
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：数据字典 &gt; 字典列表</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD>
														<%-- <a href="${pageContext.request.contextPath }/dict_delete.action?uid=${dict.did}">删除</a> --%>
													</TD>
												</TR>
