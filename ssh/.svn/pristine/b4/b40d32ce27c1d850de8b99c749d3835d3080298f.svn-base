...
<TR> 
	<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath }/customer_list"
		target=main>－ 客户列表</A></TD>
</TR>
<TR> 
	<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath }/customer_findPage.action?currentPage=1"
								...
								<TR>
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="linkman_toAddPage.action"
														target=main>－ 新增联系人</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="linkman_list.action"
								...
								<TR>
									<TD>
										<TABLE id=table_5 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="visit_toAddPage.action"
														target=main>－新增客户拜访</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="visit_listVisit.action"
								...
								<TR>
									<TD>
										<TABLE id=table_3 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="customer_toSelectCustomerPage.action"
														target=main>－ 客户信息查询</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="linkman_toSelectCustomerPage.action"
														target=main>－ 联系人信息查询</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="visit_toSelectCustomerPage.action"
								...
								<TR>
									<TD>
										<TABLE id=table_4 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="customer_toSelectCustomerSource.action"
														target=main>－客户来源统计</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="customer_toSelectCustomerLevel.action"
									...
									<TD>
										<TABLE id=table_6 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												...
												<TR>
													<TD class=menuSmall><A class=style2 href="user_list.action"
														target=main>－用户管理</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="dict_list.action"
